...
class XMLWrapper
{
     ...
     * @param array $props
     */
    protected function processParamProps(&$props = [])
    {
    ...
    {
        $patterns = ['/10i0/', '/5i0/', '/4f/', '/\d*p\d*/'];
        $replacements = ['integer', 'integer', 'float', 'float'];
