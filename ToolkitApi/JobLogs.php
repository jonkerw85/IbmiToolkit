...
class JobLogs
{
    ...
    public function __construct(?ToolkitInterface $ToolkitSrvObj = null, $tmpUSLib = DFTLIB)
    {
        if ($ToolkitSrvObj instanceof Toolkit) {
            ...
            $this->ToolkitSrvObj->setOptions(['plugSize' => '1M']);
    ...
    public function JobList($user = null, $jobstatus = '*ACTIVE')
    {
        ...
        $ret = $this->ToolkitSrvObj->PgmCall(ZSTOOLKITPGM, $this->ToolkitSrvObj->getOption('HelperLib'), $params, null, ['func' => 'JOBLIST']);
        sleep(1);
    ...
    public function JobLog($JobName, $JobUser, $JobNumber, $direction = 'L')
    {
        ...
        $OutputArray = $this->ToolkitSrvObj->PgmCall(ZSTOOLKITPGM, $this->ToolkitSrvObj->getOption('HelperLib'), $InputArray, null, ['func' => 'JOBLOGINFO']);
    ...
    public function GetJobInfo($JobName, $JobUser, $JobNumber)
    {
        ...
        $ret = $this->ToolkitSrvObj->PgmCall(ZSTOOLKITPGM, $this->ToolkitSrvObj->getOption('HelperLib'), $params, null, ['func' => 'GETJOBINFO']);
